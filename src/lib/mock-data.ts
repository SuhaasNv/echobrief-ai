...
export const meetings: Meeting[] = [
  {
    ...
    status: "ready",
    summary:
      "Aligned on a September 18 launch contingent on pricing page redesign and partner outreach.",
  ...
  },
  {
    ...
    status: "processing",
    summary:
      "Review of new onboarding flow. Empty state and waveform animation feedback collected.",
...
export const transcriptLines = [
  {
    ...
    who: "Maya Chen",
    color: "brand",
    text: "Thanks for jumping on. I want us to leave today with one decision: when does Q3 ship?",
  },
  {
    t: "00:14",
    who: "David Park",
    color: "success",
    text: "From engineering we're 80% there on the new pricing page. Two weeks of polish, plus QA.",
  },
  {
    t: "00:42",
    who: "Maya Chen",
  ...
  },
  {
    ...
    who: "Liam Ortiz",
    color: "warning",
    text: "Marketing needs the date confirmed by Monday to lock in the press cycle.",
  },
  {
    t: "01:48",
    who: "Maya Chen",
    color: "brand",
    text: "Done. I'll send a calendar hold by EOD. David, can you own the engineering rollout doc?",
  },
  { t: "02:05", who: "David Park", color: "success", text: "On it. I'll have a draft tomorrow." },
  {
    ...
    who: "Priya Rao",
    color: "violet",
    text: "What about the legacy Starter tier? Are we sunsetting at launch or after?",
  },
  {
    t: "02:30",
    who: "Maya Chen",
    color: "brand",
    text: "After. Let's not change two things at once. Decision: keep Starter through end of year.",
  },
];
...
export const actionItems = [
  {
    id: 1,
    title: "Confirm September 18 launch date with marketing",
    owner: "Maya",
    due: "Today",
  ...
  {
    id: 2,
    title: "Draft engineering rollout doc",
    owner: "David",
    due: "Tomorrow",
    meeting: "Q3 Planning Sync",
    done: false,
  ...
  {
    id: 3,
    title: "Partner outreach to top 5 integrations",
    owner: "Priya",
    due: "Fri",
    meeting: "Q3 Planning Sync",
    done: false,
  ...
  {
    id: 4,
    title: "Pricing page v2 ready for QA",
    owner: "David",
    due: "Aug 30",
    meeting: "Q3 Planning Sync",
    done: false,
  ...
  {
    id: 5,
    title: "Send Acme proposal w/ SSO add-on",
    owner: "Maya",
    due: "Fri",
  ...
  {
    id: 6,
    title: "Schedule follow-up w/ Acme VP Eng",
    owner: "Jordan",
    due: "Mon",
    meeting: "Acme Discovery",
    done: true,
  ...
  {
    id: 7,
    title: "Redesign empty state in onboarding",
    owner: "Sara",
    due: "Aug 28",
